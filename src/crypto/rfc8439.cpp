...
bool RFC8439Decrypt(const Span<const std::byte> aad, const RFC8439Key& key, const std::array<std::byte, 12>& nonce, const Span<const std::byte> input, Span<std::byte> plaintext)
{
